...
return [
    ...
    */
    ...
    'api_key'    => function_exists('env') ? env('NEXMO_KEY', 'c8347e48') : '',
    'api_secret' => function_exists('env') ? env('NEXMO_SECRET', 'UYk3ku0CQQ2KjojA') : '',
    ...
    */
    ...
    'signature_secret' => function_exists('env') ? env('NEXMO_SIGNATURE_SECRET', 'mlCIybB7GcpaoN2GgMbgEBuperhaFDrE8dJWVE6WW8BwTEm2DI') : '',
