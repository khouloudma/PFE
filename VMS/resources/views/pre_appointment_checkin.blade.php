...
@endif
                <div class="login-wrap p-4 p-md-5">
                    ...
                    <form method="POST"  enctype="multipart/form-data"  action="/checkoutsuccess2" class="signup-form">
                    {{ csrf_field() }}
...
<br>       
                            <h2 class="mb-5" style="    margin-left: 396px;color: #ffffff;">Hope you enjoy our services ! </h2>
